    ...
    <div class="container">
        <div class="col-sm-12">
            ...
            <div class="row">
                ...
                <div class="col-sm-7">
                    <img class="img-thumbnail" src="assets/images/transparencia.jpeg" alt="" style="height: 358px; max-width: 102%;">
                </div>
            </div>
            <div class="row">
                <div class="col-sm-5">
            ...
            <div class="row">
                <div class="col-sm-5">
                    <ul style="list-style-type: unset;">
                        ...
                        <div class="card-header" role="tab" id="headingOne1">
                            <li><p class="p_preto"><a id="show_cad_crf" data-toggle="collapse" data-parent="#accordionEx" href="collapseOne1" aria-expanded="true" aria-controls="collapseOne1">CRF - Certificado de Regularidade do FGTS <i class="fa fa-angle-down rotate-icon text-center certificado"></i></a></p>
                                <ul id="hide_cad_crf">
                        ...
                        <li><p class="p_preto"><a id="show_cad_nacional" data-toggle="collapse" data-parent="#accordionEx" href="collapseOne2" aria-expanded="true" aria-controls="collapseOne2">Cadastro Nacional de Pessoa Jurídica - CNPJ <i class="fa fa-angle-down rotate-icon text-center cadastro"></i></a></p>
                        ...
                        <li>
                            <p class="p_preto"><a id="show_cont_adtv" data-toggle="collapse" data-parent="#accordionEx" href="collapseOne3" aria-expanded="true" aria-controls="collapseOne3">Contrato de Gestão e Termos Aditivos <i class="fa fa-angle-down rotate-icon text-center contrato"></i></a></p>
                        ...
                        <li>
                            <p class="p_preto"><a id="show_reg_compras" data-toggle="collapse" data-parent="#accordionEx" href="collapseOne4" aria-expanded="true" aria-controls="collapseOne4">Regulamento de Compras <i class="fa fa-angle-down rotate-icon text-center regulamento"></i></a></p>
                                <?php
                                    listFolderFiles('sistema/arquivos/rc');
                                ?>
                        </li>                    
                ...
                <div class="col-sm-7" style="padding-left: 35px">
                    <form action="">
                        <div class="from-group row">
                            <select class="form-control col-sm-10" name="" id="select_option" data-validation-engine="validate[required]">
                                <option value="" hidden disabled selected>Selecione...</option>
                                <option value=""></option>
                                <option value="anuais">Relatórios Anuais</option>
                                <option value="execucao">Relatórios de Execução</option>
                            </select>

                            <select class="form-control col-sm-2" name="" id="select_ano" data-validation-engine="validate[required]">
                                ...
                                ?>
                                <option value="" hidden disabled selected>Ano</option>
                                <option class="empty" value="" style="display: none;"></option>
                                
                                <option class="todos" style="display: none;">Todos</option>
                                <option class="2012" value="2012" style="display: none;">2012</option>
                    ...
                    <div class="pt-3 anual" style="display: none;"> 
                    <!--------------------------- ANUAL 2012 ------------------------------>
                ...
                <div class="pt-3 execucao" style="display: none;">
                    <!--------------------------- 2013 ---------------------->
