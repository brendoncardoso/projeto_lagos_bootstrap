                ...
                <form method="post" action="" name="form1" id="form1">
                    <div id="conteudo">
                        ...
                        <div class="blocos">
                            ...
                            <div id="" class="box-1" style="padding-bottom: 20px;">
                                <div class="box-image center">
                                    <a href="cadastrarpasta.php" class="icon-grande icon-novo-grande">&nbsp;</a>
                                    <a href="cadastrarpasta.php" style="color: #4e4e4e">
                                        <p class="center">Cadastrar Pasta</p>
                                    </a>
                                    <!--<p class="center">Novo Documento</p>-->
                                </div>
                            </div>

                            <div id="" class="box-1" style="padding-botton: 10px;">
                                <div class="box-image center">
                                    <a href="categoria1.php" class="icon-grande icon-novo-grande">&nbsp;</a>
                                    <a href="categoria1.php" style="color: #4e4e4e">
                                        <p class="center">Categoria 1</p>
                                    </a>
                                    <!--<p class="center">Documento dentro do Documento</p>-->
                                </div>
                            </div>

                            <div id="" class="box-1" style="padding-botton: 10px;">
                                <div class="box-image center">
                                    <a href="categoria2.php" class="icon-grande icon-novo-grande">&nbsp;</a>
                                    <a href="categoria2.php" style="color: #4e4e4e">
                                        <p class="center">Categoria 2</p>
                                    </a>
                                    <!--<p class="center">Documento dentro do Documento</p>-->
                                </div>
                            </div>
                            ...
                            <div id="" class="box-1" style="padding-botton: 10px;">
                                <div class="box-image center">
                                    <a href="categoria3.php" class="icon-grande icon-novo-grande">&nbsp;</a>
                                    <a href="categoria3.php" style="color: #4e4e4e">
                                        <p class="center">Categoria 3</p>
                                    </a>
                                    <!--<p class="center">Documento dentro do Documento</p>-->
                                </div>
                            </div>
