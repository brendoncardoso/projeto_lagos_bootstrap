...
<html lang="pt">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div id="conteudo" class="col-md-10 col-lg-10 col-sm-10 col-xs-12">
                    ...
                    <div class="blocos">
						...
						<form class="form-horizontal" method="POST" action="" id="form" name="form">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-2"><button id="btn_procurar" name="btn_procurar" class="btn btn-primary">Procurar</button></div>
                                ...
                                <tbody>
                                    ...
                                    while ($row_pessoa = mysql_fetch_assoc($qr_pessoa)):
                                        ...
                                        <tr <?php echo $class; ?>>
                                            ...
                                            <td class="center"><a href="../../novo/curriculos/<?php echo $row_pessoa['arquivo_curriculo'] ?>" target="_blank"><i class="fa fa-eye fa-2x arquivo" aria-hidden="true" id="<?php echo $row_pessoa['id_curriculo'] ?>"></i></a></td>
